...
function getBezierTurnarounds(ps) {
    ...
    const turnaroundXs = rootsX.map(r => ({ t: r.t, p: toP(ps, r.t) }));
    const turnaroundYs = rootsY.map(r => ({ t: r.t, p: toP(ps, r.t) }));
    return { turnaroundXs, turnaroundYs };
}
export { getBezierTurnarounds };
//# sourceMappingURL=get-bezier-turnarounds.js.map