 ...
 * @param containers
 */
const combineOverlappingContainers = timeFunctionCalls(function combineOverlappingContainers(containers) {
    ...
    while (true) {
         ...
         */
        const rs = sweepLine(containers, container => enlargeBox(container.box, CONTAINER_MERGE_ENLARGE_FRAC)[0][0], container => enlargeBox(container.box, CONTAINER_MERGE_ENLARGE_FRAC)[1][0], areContainersIntersecting);
        ...
        const graph = new Map(containers.map(c => [c, []]));
...
//# sourceMappingURL=combine-overlapping-containers.js.map