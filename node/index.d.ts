...
export { getLoopArea, getShapeArea } from './loop/get-loop-area.js';
export { getLoopCentroid, getShapeCentroid } from './loop/get-loop-centroid.js';
export { getMomentOfInertia, getProdMomentOfInertia } from './loop/get-moment-of-inertia.js';
