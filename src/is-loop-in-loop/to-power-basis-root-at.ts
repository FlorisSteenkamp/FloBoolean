...
function toPowerBasisY0At0and1(
        ps: number[][]): number[] {
 ...
 */
function toPowerBasisY00At0and0At1(
        ps: number[][]): number[] {
 ...
 *   to a constant); lower orders give the zero polynomial.
 */
function toPowerBasisY0At0and00At1(
        ps: number[][]): number[] {
 ...
 */
function toPowerBasisY00At0and00At1(
        _ps: number[][]): number[] {
 ...
 */
function toPowerBasisRootsAtExact(
        ps: number[][],
        numRoots0: number,
        numRoots1: number): number[] {
...
export {
    toPowerBasisY0At0, toPowerBasisY00At0, toPowerBasisY000At0,
    toPowerBasisY0At1, toPowerBasisY00At1, toPowerBasisY000At1,
    toPowerBasisY0At0and1,
    toPowerBasisY00At0and0At1, toPowerBasisY0At0and00At1,
    toPowerBasisY00At0and00At1
}
